...
Source0  : https://winegui.melroy.org/downloads/WineGUI-Source-v2.7.1.tar.gz
...
%prep
%setup -q -c -n WineGUI-Source-v2.7.1.tar
cd %{_builddir}/WineGUI-Source-v2.7.1.tar
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738798992
mkdir -p clr-build
pushd clr-build
