...
Version  : 2.7.0
Release  : 6
URL      : https://winegui.melroy.org/downloads/WineGUI-Source-v2.7.0.tar.gz
Source0  : https://winegui.melroy.org/downloads/WineGUI-Source-v2.7.0.tar.gz
...
%prep
%setup -q -c -n WineGUI-Source-v2.7.0.tar
cd %{_builddir}/WineGUI-Source-v2.7.0.tar
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736182672
mkdir -p clr-build
pushd clr-build
