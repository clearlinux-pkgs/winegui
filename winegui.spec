...
Version  : 2.6.3
Release  : 3
URL      : https://winegui.melroy.org/downloads/WineGUI-Source-v2.6.3.tar.gz
Source0  : https://winegui.melroy.org/downloads/WineGUI-Source-v2.6.3.tar.gz
...
%prep
%setup -q -c -n WineGUI-Source-v2.6.3.tar
cd %{_builddir}/WineGUI-Source-v2.6.3.tar
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731597043
mkdir -p clr-build
pushd clr-build
